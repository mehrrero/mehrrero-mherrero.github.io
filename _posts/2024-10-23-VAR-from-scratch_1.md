...
$$ y_i(t) = y_i(t_0)) + \sum_{k=1}^\infty \sum_{j=1}^\infty \left.\frac{\partial^k y_i}{\partial t^k}\right_{t=t_0}\left. \frac{\partial^k y_i}{\partial x_a(t)^j}\right_{t = t_0}(t-t_0)^k (x_a(t)-x_a(t_0))^j. $$
